...
async def generate_pdf_report(
    ...
    try:
        ...
        logger.error("failed_to_generate_pdf_report", 
                    analysis_id=str(analysis_id), 
                    error=str(e))
        raise HTTPException(
...
async def generate_excel_report(
    ...
    try:
        ...
        logger.error("failed_to_generate_excel_report", 
                    analysis_id=str(analysis_id), 
                    error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_analysis_reports(
    ...
    try:
        ...
        report_responses = [ReportResponse.from_report(report) for report in paginated_reports]
        ...
        logger.error("failed_to_list_analysis_reports", 
                    analysis_id=str(analysis_id), 
                    error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_tenant_reports(
    ...
    limit: int = Query(50, ge=1, le=100, description="Maximum number of reports"),
    offset: int = Query(0, ge=0, description="Number of reports to skip"),
    report_type: Optional[str] = Query(None, description="Filter by report type (PDF/EXCEL)"),
) -> ReportListResponse:
    ...
    try:
        ...
        logger.error("failed_to_list_tenant_reports", 
                    tenant_id=str(tenant_id), 
                    error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def get_report(
    ...
    try:
        ...
        logger.error("failed_to_get_report", 
                    report_id=str(report_id), 
                    error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def download_report(
    ...
    try:
        ...
        logger.error("failed_to_get_report_download", 
                    report_id=str(report_id), 
                    error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def delete_report(
    ...
    try:
        ...
        logger.error("failed_to_delete_report", 
                    report_id=str(report_id), 
                    error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def cleanup_expired_reports(
    ...
    logger.info("cleanup_expired_reports_requested", user_email=current_user.user_principal_name)
